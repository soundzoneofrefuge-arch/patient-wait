-- ============================================
-- 🚀 SCRIPT COMPLETO DE MIGRAÇÃO DO SUPABASE
...
-- Armazena roles de usuários (admin, user, etc.)
...
-- 5.2 Função para atualizar updated_at automaticamente
...
-- 5.3 Função para atualizar updated_at em produtos
...
-- 8.4 Políticas para agendamentos_robustos
...
-- 8.7 Políticas para categorias_produto
...
-- 8.8 Políticas para produtos_loja
...
INSERT INTO public.info_loja (
    ...
    'Endereço completo',           -- ALTERE: Endereço
    '08:00:00',                    -- ALTERE: Horário de abertura
    '21:00:00',                    -- ALTERE: Horário de fechamento
    60,                            -- Intervalo em minutos
    E'PROFISSIONAL 1\nPROFISSIONAL 2',  -- ALTERE: Lista de profissionais
    E'Cabelo + Barba\nCabelo\nBarba',    -- ALTERE: Serviços oferecidos
...
-- 10.2 Inserir categorias padrão
...
2. ADICIONAR ROLE DE ADMIN para o usuário:
   - Vá em SQL Editor
   - Execute (substitua o UUID do usuário):
   
   INSERT INTO public.user_roles (user_id, role)
   VALUES ('UUID-DO-USUARIO-CRIADO', 'admin');

3. DEPLOY DAS EDGE FUNCTIONS:
   - Veja a documentação REPLICAÇÃOV2.md
